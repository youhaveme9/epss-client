...
from .cache_interface import CacheInterface, CacheKeyGenerator, CacheStats, NoOpCache
from .cache_backends import FileCache, RedisCache, DatabaseCache
...
class CacheManager:
    ...
    def get(self, method: str, **params) -> Optional[EpssResponse]:
        """
...
def create_cache_manager(config_file: Optional[str] = None) -> CacheManager:
    """
